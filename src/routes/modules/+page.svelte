  ...
  <div class="jump-groups">
    <div class="jump-group">
      ...
      <div class="jump-links">
        ...
        <a href="#point-of-sale">Counter / POS</a>
      </div>
    </div>
    <div class="jump-group">
      <span class="jump-label">Jobs &amp; field</span>
      <div class="jump-links">
        <a href="#core">Core (Jobs)</a>
...
<section class="module_container" id="purchasing">
  <h2><a href="/modules/purchasing">Purchasing &amp; advanced inventory</a></h2>
...
<section class="module_container" id="sds">
  <h2><a href="/modules/sds">Safety Data Sheets (SDS)</a></h2>
